...
class NeonTheme:
    ...
    GHOST_SWING: Color = Color(0.2, 0.1, 0.4)
    GHOST_BOOM: Color = Color(0.4, 0.2, 1.0)
    GHOST_ARM: Color = Color(0.6, 0.3, 1.0)
    GHOST_BUCKET: Color = Color(0.8, 0.4, 1.0)
    GHOST_OUTLINE: Color = Color(0.8, 0.4, 1.0, 0.9)
